...
@section('title', 'Data Obat Dan Perlengkapan')
            ...
            <div class="container-fluid mg-t-20">
				...
				<div class="breadcrumb-header justify-content-between">
					...
					<div class="left-content">
						<h4 class="content-title mb-1">Data Obat Dan Perlengkapan</h4>
                         ...
                         <form method="post" action="/cari_obat">
                             @csrf
							        <div class="input-group mb-4">
							            <input type="text" placeholder="Cari nama atau keluhan obat..." required class="form-control" name="keyword">
