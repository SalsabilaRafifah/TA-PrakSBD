			...
			<div class="main-sidemenu sidebar-scroll">
				<ul class="side-menu">
					<li class="slide">
						...
						<span class="side-menu__label">Hasil Join</span></a>
					</li>
					<li class="slide">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="/poliklinik"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    <i class="fas fa-bed" style="font-size:17px; margin-right:9px"></i>
						<span class="side-menu__label">Data Poliklinik</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="/rekam_medis"><div class="side-angle1"></div><div class="side-angle2"></div><div class="side-arrow"></div>
                    	<i class="fas fa-procedures" style="font-size:17px; margin-right:9px"></i>
						<span class="side-menu__label">Data Rekam Medis</span></i></a>
					</li>
					<li class="slide">
